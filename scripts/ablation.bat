# test_ugp
python scripts/train4.py --exp_name test_ugp --mode teacher --teacher_type UGP_v3 --data_dir ./data/ad_new --lr 1e-5;
python scripts/train4.py --exp_name test_ugp --mode student --teacher_type UGP_v3 --student_type UGP_v3 --data_dir ./data/ad_new --lr 1e-5;
python scripts/train4.py --exp_name test_ugp --mode student --teacher_type UGP_v3 --student_type MLP --data_dir ./data/ad_new --lr 1e-5;

# full (8 + 9 + 6 + 5)
python scripts/train4.py --exp_name full --mode teacher --teacher_type MLP --age_threshold 65 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type MLP --student_type MLP --age_threshold 65 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode teacher --teacher_type AgeAwareMLP1 --age_threshold 65 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeAwareMLP1 --student_type AgeAwareMLP1 --age_threshold 65 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeAwareMLP1 --student_type MLP --age_threshold 65 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode teacher --teacher_type AgeAwareMLP2 --age_threshold 65 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeAwareMLP2 --student_type AgeAwareMLP2 --age_threshold 65 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeAwareMLP2 --student_type MLP --age_threshold 65 --data_dir ./data/ad_new;

python scripts/train4.py --exp_name full --mode teacher --teacher_type UGP_v1 --data_dir ./data/ad_new --lr 1e-5;
...
python scripts/train4.py --exp_name full --mode teacher --teacher_type UGP_v2 --data_dir ./data/ad_new --lr 1e-5;
...
python scripts/train4.py --exp_name full --mode teacher --teacher_type UGP_v3 --data_dir ./data/ad_new --lr 1e-5;
python scripts/train4.py --exp_name full --mode student --teacher_type UGP_v3 --student_type UGP_v3 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type UGP_v3 --student_type MLP --data_dir ./data/ad_new;

python scripts/train4.py --exp_name full --mode teacher --teacher_type AgeUGP_v1 --data_dir ./data/ad_new --lr 1e-5;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeUGP_v1 --student_type AgeUGP_v1 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeUGP_v1 --student_type MLP --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode teacher --teacher_type AgeUGP_v2 --data_dir ./data/ad_new --lr 1e-4;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeUGP_v2 --student_type AgeUGP_v2 --data_dir ./data/ad_new;
python scripts/train4.py --exp_name full --mode student --teacher_type AgeUGP_v2 --student_type MLP --data_dir ./data/ad_new;
...
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type MLP --student_type MLP --age_threshold 65 --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.001;
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeAwareMLP1 --student_type AgeAwareMLP1 --age_threshold 65 --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.001;
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeAwareMLP1 --student_type MLP --age_threshold 65 --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.001;
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeAwareMLP2 --student_type AgeAwareMLP2 --age_threshold 65 --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.001;
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeAwareMLP2 --student_type MLP --age_threshold 65 --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.001;
...
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeUGP_v1 --student_type AgeUGP_v1 --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.0001;
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeUGP_v1 --student_type MLP --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.0001;
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeUGP_v2 --student_type AgeUGP_v2 --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.0001;
python scripts/train4.py --exp_name student_enhanced_lr3 --mode student --teacher_type AgeUGP_v2 --student_type MLP --data_dir ./data/ad_new --teacher_model_exp_name full --lr 0.0001;
