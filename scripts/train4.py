...
from src.utils import set_random_seed, seed_worker, collate_fn, split_by_age, check_data, check_cuda, get_model, get_optimizer
...
def run_experiment(args):
    ...
    if args.teacher_type in ["UGP_v1", "UGP_v2", "AgeUGP_v1", "AgeUGP_v2", "UGP_v3", "ctrUGP_v1"] or args.student_type in ["UGP_v1", "UGP_v2", "AgeUGP_v1", "AgeUGP_v2", "UGP_v3", "ctrUGP_v1"]:
        ...
        if args.teacher_type in ["UGP_v3", "ctrUGP_v1"] or args.student_type in ["UGP_v3", "ctrUGP_v1"]:
    ...
    for run in range(1, args.n_runs + 1):
        ...
        if args.mode == "teacher":
            ...
            trainer = Trainer(
                ...
                gene_g=gene_g if args.teacher_type in ["UGP_v3", "ctrUGP_v1"] else None,
                args=args
            )
            ...
            trainer = KDTrainer(
                ...
                gene_g=gene_g if args.teacher_type in ["UGP_v3", "ctrUGP_v1"] or args.student_type in ["UGP_v3", "ctrUGP_v1"] else None,
                args=args
            )
...
if __name__ == '__main__':
    ...
    check_cuda()
    set_random_seed()
    torch.use_deterministic_algorithms(True) ##debug
    run_experiment(args)