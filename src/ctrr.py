...
from simsias_models import SimSiam
...
parser.add_argument('--epochs', type=int, default=550, helzp='number of training epochs')
...
def train(train_loader, model, criterion, optimizer, epoch,  args):
    ...
    for i, (images, targets, _, index) in enumerate(train_loader):
        ...
        soft_tabrgets = torch.softmax(outputs, dim=1)
