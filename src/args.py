...
def parse_train_args():
    ...
    parser.add_argument("--data_dir", type=str, default='./data/ad', choices=['./data/ad','./data/ms','./data/uc','./data/af','./data/mix_1'])
    parser.add_argument("--mix_target", type=str, default='ad', choices=['ad', 'ms', 'uc', 'af'])
    ...
    parser.add_argument("--n_early_stop", type=int, default=10)
    ...
    parser.add_argument("--bgce_q", type=float, default=0.6)
    parser.add_argument("--use_mixup", action='store_true')
    parser.add_argument("--mixup_alpha", type=float, default=0.2)
    parser.add_argument("--use_elr", action='store_true')
    parser.add_argument("--use_asym_noise", action='store_true')
    parser.add_argument("--asym_noise_ratio", type=float, default=0.5)
